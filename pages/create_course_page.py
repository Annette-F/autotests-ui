...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.exercises_title_empty_view_title = page.get_by_test_id('create-course-exercises-empty-view-title-text')
    ...
    def check_visible_exercises_empty_view(self):
        ...
        expect(self.exercises_title_empty_view_title).to_be_visible()
        expect(self.exercises_title_empty_view_title).to_have_text('There is no exercises')
