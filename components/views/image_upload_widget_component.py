...
class ImageUploadWidgetComponent(BasePage):
    ...
    # Проверяет отображение виждета в зависимости от наличия загруженного изображения
    def check_visible(self, is_image_uploaded: bool = False):
        ...
        if not is_image_uploaded:
            # Если картинка нен загружена, проверяем наличие компонента EmptyViewComponent
